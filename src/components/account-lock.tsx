...
export function AccountLock({ reason = "upgrade", notice, onDismiss }: { reason?: "upgrade" | "hold"; notice?: string | null | undefined; onDismiss?: (() => void) | undefined }) {
      ...
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 text-center">
        ...
        <p className="mt-4 text-base text-muted-foreground">
          {onHold
            ...
            : trimmed || "Please upgrade your account, your current investment plan does not support this action!"}
        </p>
        {!onHold && trimmed && (
          <p className="mt-4 text-base text-muted-foreground">Please upgrade your account, your current investment plan does not support this action!</p>
        )}
